...
该项目为闭源专业版的发型仓库，提供功能介绍、技术文档、二进制下载等功能。
闭源专业版需要经过授权后才能开启专业版相关功能，如果授权失败，则功能和用法和开源版完全一致。
...
## 怎么开启专业版功能？
- 程序的试用：
  程序开启试用时必须联网，默认支持7天全功能全额度试用；试用必须在非docker环境内开启，每台机器默认只能试用一次。
...
## docker下载
```bash
docker pull zlmediakitpro/zlmediakit-pro:feature_all
```
